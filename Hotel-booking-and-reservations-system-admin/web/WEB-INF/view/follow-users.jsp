            ...
            <div class="panel-body table-responsive">
                ...
                <table id="myTable1">
                    <tr>
                        ...
                        <th style="cursor: pointer" onclick="sortNum(2, 'myTable1')">Visit Times</th>
                    </tr>

                    <c:forEach var="map" items="${mapFollowUsersIP}" varStatus="loop">
                        <tr style="cursor: pointer" onclick="location.href = '${pageContext.request.contextPath}/follow-user-ip/${map.key}.htm'">
                            <td>${loop.index + 1}</td>
                            <td>${map.key}</td>
                            <td>${map.value}</td>
                        </tr>
            ...
            <div class="panel-body table-responsive">
                ...
                <table id="myTable2">
                    <tr>
                        ...
                        <th style="cursor: pointer" onclick="sortAlpha(1, 'myTable2')">Page Access</th>
                        <th style="cursor: pointer" onclick="sortNum(2, 'myTable2')">Visit Times</th>
                    </tr>
